...
## QA Júnior | Testes Manuais | API Testing | SQL para QA | Automação com Cypress
...
Tenho experiência prática documentada em Quality Assurance por meio de projetos públicos no GitHub, envolvendo criação de casos de teste, cenários de teste, execução manual de testes funcionais, testes de API, validação de dados com SQL, registro de bugs, documentação de evidências e automação de testes end-to-end com Cypress.
...
<p>
  <img src="https://img.shields.io/badge/Postman-30363D?style=for-the-badge&logo=postman&logoColor=FF6C37" />
  <img src="https://img.shields.io/badge/PostgreSQL-30363D?style=for-the-badge&logo=postgresql&logoColor=4169E1" />
  <img src="https://img.shields.io/badge/DBeaver-30363D?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Cypress-30363D?style=for-the-badge&logo=cypress&logoColor=white" />
  <img src="https://img.shields.io/badge/Selenium-30363D?style=for-the-badge&logo=selenium&logoColor=43B02A" />
  <img src="https://img.shields.io/badge/Playwright-30363D?style=for-the-badge" />
</p>

<p>
  <img src="https://img.shields.io/badge/JavaScript-30363D?style=for-the-badge&logo=javascript&logoColor=F7DF1E" />
  <img src="https://img.shields.io/badge/Node.js-30363D?style=for-the-badge&logo=nodedotjs&logoColor=339933" />
  ...
  <img src="https://img.shields.io/badge/Markdown-30363D?style=for-the-badge&logo=markdown&logoColor=white" />
</p>

<p>
  <img src="https://img.shields.io/badge/Scrum-30363D?style=for-the-badge" />
  <img src="https://img.shields.io/badge/PSM%20I-30363D?style=for-the-badge" />
  <img src="https://img.shields.io/badge/BI-30363D?style=for-the-badge" />
  <img src="https://img.shields.io/badge/An%C3%A1lise%20de%20Dados-30363D?style=for-the-badge" />
</p>
...
Projeto prático de Quality Assurance simulando a atuação de um Analista de Qualidade em uma aplicação web.

O projeto utiliza o site SauceDemo para testes manuais web, com foco em fluxo de login, carrinho, checkout, validações de campos obrigatórios e documentação de bugs.
...
- Validação de fluxos de login e checkout;
- Registro e documentação de bugs;
- Análise de impacto de negócio;
- Organização de evidências;
- Versionamento da documentação com Git e GitHub.
...
Projeto prático de testes de API utilizando Postman e a API pública JSONPlaceholder.

O objetivo do projeto é demonstrar validações de requisições HTTP, análise de respostas, códigos de status, payloads JSON e documentação de testes de API.

**Principais entregas:**

- Testes de requisições GET;
- Testes de requisições POST;
- Testes de requisições PUT;
- Testes de requisições DELETE;
- Validação de status code;
- Validação de estrutura JSON;
- Validação de campos retornados na resposta;
- Organização de cenários de teste de API;
- Documentação técnica dos testes executados.

[Acessar projeto](https://github.com/brunolopes-ti/api-tests)

---

### QA SQL Validation Project

Projeto prático de validação de dados com SQL aplicado à área de Quality Assurance.

O projeto simula um banco de dados de e-commerce utilizando PostgreSQL e DBeaver, com foco em validação de regras de negócio, consistência de dados e consultas utilizadas por QA.
...
- Validação de consistência entre pedidos e itens;
- Dicionário de dados;
- Cenários de teste SQL;
- Evidências de execução no DBeaver.

[Acessar projeto](https://github.com/brunolopes-ti/qa-sql-validation)
...
- Escrita de casos e cenários de teste;
...
- Gestão da Tecnologia da Informação — Superior completo;
...
**LinkedIn:** linkedin.com/in/brunolopes-ti  
**GitHub:** github.com/brunolopes-ti
