...
Projeto prático de testes manuais funcionais utilizando o site SauceDemo.

**Objetivo:** demonstrar criação, execução e documentação de casos de teste manuais, com foco em fluxos funcionais de uma aplicação web.
...
### QA SQL Validation - Validação de Dados com SQL

Projeto prático de validação de dados utilizando PostgreSQL, DBeaver e SQL.

**Objetivo:** demonstrar consultas SQL aplicadas à validação de regras de negócio, consistência de dados e integridade das informações.

**Principais práticas:**

- Criação de tabelas relacionais;
- Inserts de massa de dados;
- Consultas SQL;
...
### QA Cypress Lab - Automação E2E com Cypress

Projeto prático de automação de testes end-to-end com Cypress e JavaScript utilizando o SauceDemo.

**Objetivo:** demonstrar automação de fluxos web com Cypress, cobrindo cenários funcionais de login, carrinho e checkout.
...
- Checkout completo;
- Execução da suíte via terminal;
...
### QA Selenium Lab - Automação E2E com Selenium WebDriver

Projeto prático de automação de testes end-to-end com Selenium WebDriver, JavaScript, Node.js e Mocha.

**Objetivo:** demonstrar automação web utilizando Selenium WebDriver, ferramenta amplamente utilizada no mercado de QA.
...
**Objetivo:** demonstrar automação web moderna com Playwright, organização profissional dos testes com Page Object Model e execução automatizada com GitHub Actions.
